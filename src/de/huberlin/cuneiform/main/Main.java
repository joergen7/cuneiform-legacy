...
public class Main {
	...
	private static final String LABEL_VERSION = "version 1.0 build 2014-04-24";

	public static void main( String[] args )
	throws ParseException, IOException, NotDerivableException, InterruptedException {
	...
	throws IOException, NotDerivableException, InterruptedException {
